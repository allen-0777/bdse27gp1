...
#     return render_template('index2.html',show_results="false", stocklen=len(stock_files), stock_files=stock_files, len2=len([]),
#                            all_prediction_data=[],
...
#     return render_template('index2.html',all_test_evaluations=all_test_evaluations, show_results="true", stocklen=len(stock_files), stock_files=stock_files,
